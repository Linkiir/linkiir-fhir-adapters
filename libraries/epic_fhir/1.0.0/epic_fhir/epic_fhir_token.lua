-- ---------------------------------------------------------------------------
-- epic_fhir_token - access token cache
--
-- Epic access tokens are valid for about an hour, so re-authenticating on
...
-- Epic environment cannot hand the wrong token to the wrong endpoint.
local Cache = {}
